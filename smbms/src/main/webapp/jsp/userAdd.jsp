...
<head lang="en">
    ...
    <script type="text/javascript">
      ...
      function add() {
          var user=$("[name=addUsers]").serializeArray();
             alert(user);
           $.post("${pageContext.request.contextPath}/addUsers",user,function (data) {
               if(data!=null){
                   alert("成功");
               }else{
                   alert("失败");
        ...
        <div class="providerAdd">
            <form action="#" name="addUsers">
                ...
                <div>
                    ...
                    <input type="radio" name="userType" value="1"/>普通用户
